...
class Driver(models.Model):
    id = models.BigAutoField(primary_key=True)
    operation = models.ForeignKey('Operation', models.DO_NOTHING, db_column='operation')
    name = models.TextField()
    driver_performance = models.IntegerField()
...
class NavicationRecord(models.Model):
    id = models.BigAutoField(primary_key=True)
